...
websocket-connection_lost-desc = يبدو أن خادم VoidReality تعطل. تحقق من السجلات وأعد تشغيل البرنامج
websocket-timedout = تعذر الاتصال بالخادم
websocket-timedout-desc = يبدو أن خادم VoidReality قد تعطل أو انتهت مهلته. تحقق من السجلات وأعد تشغيل البرنامج
websocket-error-close = الخروج من VoidReality
websocket-error-logs = افتح مجلد السجلات

## Update notification

version_update-title = نسخة جديدة متوفرة: { $version }
version_update-description = سيؤدي النقر على "{ version_update-update }" إلى تنزيل مثبت VoidReality نيابة عنك.
...
tips-turn_on_tracker = هل تستخدم أجهزة تعقب VoidReality الرسمية؟ تذكر  <b><em> أن تشغل أجهزة التعقب </em></b> بعد توصيلها بالكمبيوتر!
...
board_type-GLOVE_IMU_SLIMEVR_DEV = قفاز VoidReality تطوير IMU
...
tracker-settings-forget-description = يزيل جهاز التعقب من خادم VoidReality ويمنعه من الاتصال به حتى يتم إعادة تشغيل الخادم. لن تضيع تكوين جهاز التعقب.
...
settings-general-interface-connected_trackers_warning-description = سيعرض هذا الخيار نافذة كل مرة تحاول فيها الخروج من VoidReality أثناء وجود جهاز أو أكثر من أجهزة التعقب المتصلة. سيذكرك بإيقاف تشغيل أجهزة التعقب عند الانتهاء للحفاظ على عمر البطارية.
...
settings-general-interface-use_tray-description = يتيح لك إغلاق النافذة دون إغلاق خادم VoidReality حتى تتمكن من الاستمرار في استخدامه دون إزعاجك من واجهة المستخدم الرسومية.
...
settings-general-interface-discord_presence-description = يخبر عميل Discord الخاص بك أنك تستخدم VoidReality جنبا إلى جنب مع عدد أجهزة تعقب IMU التي تستخدمها.
...
settings-interface-behavior-error_tracking-description_v2 =
    ...
    <b>نحن لا نجمع معلومات شخصية</b> مثل عنوان IP الخاص بك أو بيانات الاعتماد اللاسلكية. يقدر VoidReality خصوصيتك!
    
    لتوفير أفضل تجربة للمستخدم، نقوم بجمع تقارير الأخطاء ومقاييس الأداء ومعلومات نظام التشغيل مجهولة المصدر. يساعدنا هذا في اكتشاف الأخطاء والمشكلات المتعلقة ب VoidReality. يتم جمع هذه المقاييس عبر Sentry.io.
...
settings-utils-advanced-open_data-description-v1 = فتح مجلد إعدادات VoidReality في مستكشف الملفات ، والذي يحتوي على الإعدادات
settings-utils-advanced-open_data-label = فتح المجلد
settings-utils-advanced-open_logs = مجلد السجلات
settings-utils-advanced-open_logs-description = افتح مجلد سجلات VoidReality في مستكشف الملفات ، والذي يحتوي على سجلات التطبيق
...
onboarding-automatic_proportions-requirements-descriptionv2 =
    ...
    أجهزة التعقب وجهاز الواقع الافتراضي متصلة بخادم VoidReality وتعمل بشكل صحيح (مثلاً، لا يوجد تأتأة أو قطع اتصال ، إلخ).
    يقوم جهاز الواقع الافتراضي بالإبلاغ عن البيانات الموضعية إلى خادم VoidReality (وهذا يعني عموما تشغيل SteamVR وتوصيله ب VoidReality باستخدام برنامج تشغيل SteamVR الخاص ب VoidReality).
...
trackers_still_on-modal-description =
    ...
    هل مازلت تريد الخروج من VoidReality؟
trackers_still_on-modal-confirm = الخروج من VoidReality
...
status_system-StatusSteamVRDisconnected =
    { $type ->
        [steamvr_feeder] حاليًا غير متصل بتطبيق VoidReality Feeder.
       *[other] حاليًا غير متصل بـ SteamVR عبر برنامج تشغيل VoidReality.
    }
...
firmware_tool-flashbtn_step-board_SLIMEVR = أوقف تشغيل جهاز التعقب، قم بإزالة العلبة (إن وجدت)، وقم بتوصيل كابل USB بهذا الكمبيوتر ، ثم قم بإحدى الخطوات التالية وفقا لمراجعة لوحة VoidReality:
