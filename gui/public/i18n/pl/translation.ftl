...
websocket-connection_lost-desc = Wygląda na to, że serwer VoidReality przestał działać. Sprawdź dzienniki i uruchom ponownie program
websocket-timedout = Nie można połączyć się z serwerem
websocket-timedout-desc = Wygląda na to, że serwer VoidReality uległ awarii lub upłynął limit czasu. Sprawdź dzienniki i uruchom ponownie program
websocket-error-close = Wyjdź ze VoidReality
websocket-error-logs = Otwórz folder dzienników

## Update notification

version_update-title = Dostępna jest nowa wersja: { $version }
version_update-description = Kliknięcie "{ version_update-update }" spowoduje pobranie instalatora VoidReality.
...
tips-turn_on_tracker = Używasz oficjalnych trackerów VoidReality? Pamiętaj, <b><em>aby włączyć tracker</em></b> po podłączeniu go do komputera!
...
board_type-SLIMEVR_DEV = VoidReality Płytka Deweloperska
...
board_type-GLOVE_IMU_SLIMEVR_DEV = Rękawica VoidReality Dev IMU
...
tracker-settings-forget-description = Usuwa moduł śledzący z serwera VoidReality i uniemożliwia mu połączenie się z nim do czasu ponownego uruchomienia serwera. Konfiguracja modułu śledzącego nie zostanie utracona.
...
settings-general-steamvr-description =
    ...
    Przydatne jeżeli chcesz więcej kontroli nad VoidReality.
...
settings-general-interface-connected_trackers_warning-description = Ta opcja wyświetli wyskakujące okienko za każdym razem, gdy spróbujesz wyjść ze VoidReality, mając jeden lub więcej podłączonych trackerów. Przypomina o wyłączeniu trackerów, gdy skończysz, aby wydłużyć żywotność baterii.
...
settings-general-interface-use_tray-description = Pozwala zamknąć okno bez wyłączania serwera VoidReality, aby używać trackerów bez interfejsu graficznego.
...
settings-general-interface-discord_presence-description = Informuje Twojego klienta Discord o korzystaniu ze VoidReality oraz o liczbie używanych trackerów IMU.
...
settings-interface-behavior-error_tracking-description_v2 =
    ...
    <b>Nie gromadzimy danych osobowych</b> , takich jak adres IP lub dane uwierzytelniające sieci bezprzewodowej. VoidReality ceni Twoją prywatność!
    
    Aby zapewnić jak najlepsze wrażenia użytkownika, gromadzimy anonimowe raporty o błędach, wskaźniki wydajności i informacje o systemie operacyjnym. Pomaga nam to wykrywać błędy i problemy ze VoidReality. Dane te są zbierane za pomocą Sentry.io.
...
settings-osc-router-network-description =
    ...
    Mogą to być takie same porty, jak inne porty używane na serwerze VoidReality.
...
settings-osc-vmc-description =
    ...
    aby wysyłać dane z kości VoidReality i odbierać dane kości z innych aplikacji.
...
settings-utils-advanced-open_data-description-v1 = Otwórz folder konfiguracyjny VoidReality w eksploratorze plików, zawierający konfigurację
settings-utils-advanced-open_data-label = Otwórz folder
settings-utils-advanced-open_logs = Folder dzienników
settings-utils-advanced-open_logs-description = Otwórz folder dzienników VoidReality w eksploratorze plików, zawierający dzienniki aplikacji
...
onboarding-setup_warning =
    ...
    i jest to wymagane, jeśli używasz VoidReality po raz pierwszy.
...
onboarding-home = Witamy w VoidReality
...
onboarding-connect_serial-error-modal-no_serial_device_found-desc =
    ...
    Jeśli to nie zadziała:
      ...
      - spróbuj ponownie zainstalować serwer VoidReality i wybierz "Sterowniki USB" w sekcji komponentów
...
onboarding-automatic_mounting-description = Aby VoidReality działało prawidłowo, musimy przypisać rotacje trackera aby zgadzała się ona z tą w prawdziwym życiu.
...
onboarding-automatic_proportions-description = Aby VoidReality działało poprawnie, musimy znać długość twoich kości. Ta kalibracja zrobi to za ciebie.
...
onboarding-automatic_proportions-requirements-descriptionv2 =
    ...
    Twoje trackery i heaset są połączone z serwerem VoidReality i działają poprawnie (np. nie ma przycięć, rozłączeń itp.).¶
    Twój headset raportuje dane o pozycji do serwera VoidReality (zazwyczaj oznacza to, że SteamVR jest uruchomiony i podłączony do VoidReality za pomocą sterownika SteamVR VoidReality).¶
...
onboarding-user_height-description = Potrzebujemy twojego wzrostu, aby obliczyć proporcje ciała i dokładnie oddać twoje ruchy. Możesz pozwolić VoidReality to obliczyć albo wpisać swój wzrost ręcznie.
...
trackers_still_on-modal-description =
    ...
    Czy nadal chcesz wyjść ze VoidReality?
trackers_still_on-modal-confirm = Wyjdź ze VoidReality
...
status_system-StatusSteamVRDisconnected =
    { $type ->
        [steamvr_feeder] Nie można połączyć się z aplikacją VoidReality Feeder.
       *[other] Nie można połączyć się ze SteamVR przez sterownik VoidReality.
    }
...
status_system-StatusPublicNetwork =
    { $count ->
        [one] Twoja karta sieciowa jest ustawiona jako publiczna: { $adapters }. Nie jest to zalecane, aby VoidReality działał poprawnie. <PublicFixLink>Zobacz, jak to naprawić tutaj.</PublicFixLink>
        [few] Niektóre karty sieciowe są ustawione jako publiczne: { $adapters }. Nie jest to zalecane, aby VoidReality działał poprawnie. <PublicFixLink>Zobacz, jak to naprawić tutaj.</PublicFixLink>
       *[many] Dużo twoich karty sieciowych jest ustawionych jako publiczne: { $adapters }. Nie jest to zalecane, aby VoidReality działał poprawnie. <PublicFixLink>Zobacz, jak to naprawić tutaj.</PublicFixLink>
    }
...
firmware_tool-flashbtn_step-board_SLIMEVR =
    ...
    Oto kilka zdjęć, jak to zrobić, zgodnie z różnymi wersjami trackera VoidReality
...
firmware_update-devices-description = Wybierz trackery, które chcesz zaktualizować do najnowszej wersji oprogramowania VoidReality
...
unknown_device-modal-description =
    ...
    Czy chcesz podłączyć go do VoidReality?
...
vrc_config-page-desc = Ta strona pokazuje stan ustawień VRChat i pokazuje, jakie ustawienia są niekompatybilne ze VoidReality. Zdecydowanie zaleca się naprawienie wszelkich pojawiających się tutaj ostrzeżeń, aby zapewnić najlepsze wrażenia użytkownika z VoidReality.
...
tracking_checklist-status-incomplete = Nie jesteś przygotowany aby korzystać ze VoidReality!
...
tracking_checklist-status-complete = Jesteś gotowy korzystać ze VoidReality!
...
tracking_checklist-NETWORK_PROFILE_PUBLIC-desc =
    { $count ->
        [one]
            ...
            { $adapters }
            Nie zaleca się tego, aby VoidReality działał poprawnie.
