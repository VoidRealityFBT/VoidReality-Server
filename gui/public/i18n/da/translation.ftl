...
version_update-description = Ved at klikke på "Opdater" downloades VoidReality-installationsprogrammet for dig.
...
settings-osc-router-network-description =
    ...
    Disse kan være de samme som de andre porte der bruges på VoidReality-serveren.
...
settings-osc-vmc-description =
    Skift indstillinger, der er specifikke for VMC-protokollen (Virtual Motion Capture)
        for at sende VoidRealitys data og modtage data fra andre apps.
...
onboarding-setup_warning =
    ...
    det er nødvendigt, hvis det er første gang, du bruger VoidReality.
