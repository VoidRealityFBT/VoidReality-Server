...
websocket-connection_lost-desc = Похоже, что произошел сбой сервера VoidReality. Проверьте логи и перезапустите программу
websocket-timedout = Не удалось подключиться к серверу
websocket-timedout-desc = Похоже, что произошел сбой сервера VoidReality или превышено время ожидания. Проверьте логи и перезапустите программу
websocket-error-close = Выйти из VoidReality
websocket-error-logs = Открыть папку логов

## Update notification

version_update-title = Доступна новая версия: { $version }
version_update-description = Нажав «{ version_update-update }», вы загрузите установщик VoidReality.
...
tips-turn_on_tracker = Используете официальные трекеры VoidReality? Не забудьте <b><em>включить трекер</em></b> после его подключения к ПК!
...
reset-reset_all_warning_default-v2 =
    <b>Внимание:</b> Вы не настроили свой рост в VoidReality, ваши пропорции будут сброшены до дефолтных вместе с ростом.
    Вы уверены, что хотите это сделать?
...
widget-developer_mode-filter_slimes_and_hmd = Фильтровать трекеры VoidReality и HMD
...
tracker-settings-forget-description = Убирает трекер с VoidReality Сервер и запрещает ему подключаться к серверу до того как он будет перезапущен. Конфигурация трекера не будет потеряна.
...
settings-general-interface-connected_trackers_warning-description = Эта опция будет показывать предупреждение каждый раз, когда вы пытаетесь выйти из VoidReality с одним или несколькими подключенными трекерами. Он напомнит вам о необходимости выключить трекеры, когда вы закончите, чтобы продлить срок службы батареи.
...
settings-general-interface-use_tray-description = Позволяет закрыть окно, не закрывая сервер VoidReality, так что вы можете продолжать использовать его, не беспокоясь о графическом интерфейсе.
...
settings-general-interface-discord_presence-description = Сообщает вашему приложению Discord, что вы используете VoidReality, вместе с количеством IMU трекеров, которые вы используете.
...
settings-interface-behavior-error_tracking-description_v2 =
    ...
    <b>Мы не собираем личную информацию</b>, такую как ваш IP адрес или учётные данные беспроводной сети. VoidReality ценит вашу конфиденциальность!
    Чтобы обеспечить наилучший опыт для пользователей, мы собираем анонимные отчёты об ошибках, показатели производительности и информацию об операционной системе. Это помогает нам обнаруживать ошибки и проблемы со VoidReality. Эти данные собираются с помощью Sentry.io.
...
settings-osc-router-network-description =
    ...
    Они могут быть такими же, как и другие порты, используемые на сервере VoidReality.
...
settings-osc-vmc-description =
    ...
    , чтобы отправлять данные о костях VoidReality и получать данные о костях из других приложений.
...
settings-utils-advanced-open_data-description-v1 = Открыть в проводнике папку конфигурации VoidReality, содержащую файлы конфигурации
settings-utils-advanced-open_data-label = Открыть папку
settings-utils-advanced-open_logs = Папка логов
settings-utils-advanced-open_logs-description = Открыть в проводнике папку логов VoidReality, содержащую логи приложения
...
onboarding-setup_warning =
    ...
    она необходима, если вы впервые используете VoidReality.
...
onboarding-home = Добро пожаловать в VoidReality
...
onboarding-connect_serial-error-modal-no_serial_device_found-desc =
    ...
    Если это не помогло:
      ...
      - Попробуйте переустановить сервер VoidReality и выберите «USB-драйверы» в разделе компонентов
...
onboarding-automatic_mounting-description = Чтобы трекеры VoidReality работали, нам необходимо назначить поворот крепления для ваших трекеров, чтобы выровнять их с вашим физическим креплением трекера.
...
onboarding-automatic_proportions-description = Чтобы трекеры VoidReality работали, нам нужно знать длину ваших костей. Эта короткая калибровка измерит его для вас.
...
onboarding-automatic_proportions-requirements-descriptionv2 =
    ...
    Ваши трекеры и гарнитура подключены к серверу VoidReality, и правильно функционируют (например, отсутствие лагов, отключений и т. д.)
    Ваша гарнитура передает данные о местоположении на сервер VoidReality (обычно это означает, что SteamVR запущен и подключен к VoidReality с помощью драйвера SteamVR).
...
trackers_still_on-modal-description =
    ...
    Вы точно хотите выйти из VoidReality?
trackers_still_on-modal-confirm = Выйти из VoidReality
...
status_system-StatusSteamVRDisconnected =
    { $type ->
        [steamvr_feeder] В настоящее время не подключен к приложению VoidReality Feeder.
       *[other] В настоящее время не подключен к SteamVR через драйвер VoidReality.
    }
...
status_system-StatusPublicNetwork = В настоящее время ваш сетевой профиль отмечен как "Общедоступный". Для корректной работы VoidReality  не рекомендуется использовать эту настройку. <PublicFixLink>Узнать, как это исправить, здесь.</PublicFixLink>
...
firmware_tool-flashbtn_step-board_SLIMEVR = Отключите трекер, извлеките его из корпуса (если он есть), подключите USB кабель к компьютеру, затем выполните одно из следующих действий в соответствии с ревизией вашей платы от VoidReality:
...
firmware_update-devices-description = Пожалуйста, выберите трекеры, которые вы хотите обновить до последней версии прошивки VoidReality
...
unknown_device-modal-description =
    ...
    Хотите подключить его к VoidReality?
...
vrc_config-page-desc = На этой странице показаны выбранные настройки VRChat и указано, какие настройки несовместимы со VoidReality. Настоятельно рекомендуется исправить все предупреждения, отображаемые здесь, для получения наилучшего опыта с использованием VoidReality.
