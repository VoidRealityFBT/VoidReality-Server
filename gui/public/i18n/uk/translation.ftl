...
version_update-description = Натискання "{ version_update-update }" почнеться завантаження VoidReality installer.
...
tips-turn_on_tracker = Використовуєте офіційні трекери VoidReality? Не забудьте <b><em>увімкнути трекер</em></b> після підключення до ПК!
...
tracker-settings-forget-description = Прибирає трекер із VoidReality і забороняє йому підключатися до сервера до того, як він буде перезапущений. Конфігурацію трекера не буде втрачено.
...
settings-general-steamvr-trackers-tracker_toggling-description = Автоматично займається увімкненням та вимкненням трекерів VoidReality залежно від поточних призначень ваших трекерів
...
settings-general-interface-connected_trackers_warning-description = Ця опція відображатиме спливаюче вікно кожного разу, коли ви намагатиметеся вийти зі VoidReality, якщо підключено один або декілька трекерів. Він нагадує вам вимкнути ваші трекери, коли ви закінчите, щоб зберегти заряд батареї.
...
settings-general-interface-use_tray-description = Дозволяє закрити вікно, не закриваючи сервер VoidReality, так що ви можете продовжувати використати його, не турбуючись про інтерфейс.
...
settings-general-interface-discord_presence-description = Повідомляє вашому клієнту Discord, що ви використовуєте VoidReality, а також передає кількість трекерів IMU, які ви використовуєте.
...
settings-osc-router-network-description =
    ...
    Вони можуть бути такими ж, як і інші порти, що використовуються на сервері VoidReality.
...
settings-osc-vmc-description =
    Змінення настройок протоколу VMC (Virtual Motion Capture)
        щоб надсилати дані про кістки VoidReality та отримувати дані про кістки з інших програм.
...
onboarding-setup_warning =
    ...
    це потрібно, якщо ви вперше використовуєте VoidReality.
...
onboarding-home = Ласкаво просимо до VoidReality
...
unknown_device-modal-description =
    ...
    Бажаєте підключити його до VoidReality?
