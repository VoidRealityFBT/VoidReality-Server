...
websocket-connection_lost-desc = Máy chủ VoidReality bị dừng. Hãy kiểm tra nhật ký logs và khởi động lại chương trình.
websocket-timedout = Không thể tìm thấy máy chủ
websocket-timedout-desc = Có vẻ như máy chủ VoidReality đã bị sập hoặc hết thời gian chờ. Vui lòng kiểm tra nhật ký logs và khởi động lại chương trình.
websocket-error-close = Thoát VoidReality
websocket-error-logs = Mở thư mục nhật ký logs

## Update notification

version_update-title = Phiên bản mới có thể cập nhật:
version_update-description = Nhấp vào "{ version_update-update }" sẽ tải xuống trình cài đặt VoidReality cho bạn.
...
tips-turn_on_tracker = Sử dụng thiết bị VoidReality chính thức? Hãy nhớ <b><em>bật trình theo dõi của bạn</em></b> sau khi kết nối thiết bị với máy tính!
...
tracker-settings-forget-description = Xóa thiết bị khỏi phần mềm VoidReality và ngăn nó kết nối với nó cho đến khi máy chủ được khởi động lại. Cấu hình của trình theo dõi sẽ không bị mất.
...
settings-general-tracker_mechanics-save_mounting_reset-description =
    ...
    khi mặc một bộ đồ VoidReality mà trình theo dõi không di chuyển giữa các phiên. <b>Không được khuyến khích cho người dùng bình thường!</b>
...
settings-general-interface-connected_trackers_warning-description = Tùy chọn này sẽ hiển thị cửa sổ bật lên mỗi khi bạn thử thoát khỏi VoidReality trong khi có một hoặc nhiều thiết bị theo dõi được kết nối. Nó nhắc nhở bạn tắt trình theo dõi khi bạn hoàn tất để duy trì tuổi thọ pin.
...
settings-general-interface-use_tray-description = Cho phép bạn đóng cửa sổ mà không cần đóng máy chủ VoidReality để bạn có thể tiếp tục sử dụng nó mà không bị GUI làm phiền.
...
settings-general-interface-discord_presence-description = Cho Discord của bạn biết rằng bạn đang sử dụng VoidReality cùng với số lượng trình theo dõi IMU bạn đang sử dụng.
...
settings-osc-router-network-description =
    ...
    Có thể dùng chung cổng với server VoidReality
...
settings-osc-router-network-address-description = Địa chỉ mạng mà VoidReality sẽ gửi dữ liệu OSC đến
...
settings-osc-vrchat-network-trackers-description = Chọn các tracker mà VoidReality sẽ gửi dữ liệu OSC đến VRChat
...
settings-osc-vmc-description =
    Thay đổi cài đặt cụ thể cho giao thức VMC (Virtual Motion Capture)
        để gửi dữ liệu thân của VoidReality và nhận dữ liệu thân từ các ứng dụng khác.
...
onboarding-setup_warning =
    ...
    bước này cần thiết nếu đây là lần đầu tiên bạn sử dụng VoidReality.
...
onboarding-home = Chào mừng bạn đến với VoidReality!
...
onboarding-connect_tracker-connection_status-done = Đã kết nối đến máy chủ VoidReality
...
onboarding-automatic_mounting-description = VoidReality cần biết hướng gắn thực của tracker để hoạt động đúng, làm theo hướng dẫn để cân chỉnh hướng gắn tự động
...
onboarding-automatic_mounting-put_trackers_on-description = Để cân chỉnh hướng gắn của tracker, VoidReality sẽ tiến hành đo góc nghiêng của tracker khi đang đeo để cân chỉnh hướng gắn, hãy đeo tracker theo đúng vị trí đã thiết lập
...
onboarding-automatic_proportions-description = Để tracker có vị trí chính xác, VoidReality cần biết các chỉ số kích thước cơ thể, làm theo hướng dẫn để đo kích thước cơ thể tự động
...
onboarding-automatic_proportions-put_trackers_on-description = Để đo kích thước cơ thể, VoidReality sẽ sử dụng một thuật toán để dự đoán kích thước của các bộ phận, hãy đeo tracker theo đúng vị trí đã thiết lập như hình bên
...
onboarding-automatic_proportions-requirements-descriptionv2 =
    ...
    Tracker và headset của bạn được kết nối với máy chủ VoidReality và đang hoạt động bình thường (ví dụ: không bị lag, ngắt kết nối, v.v.).
    Headset của bạn đang báo cáo dữ liệu vị trí cho máy chủ VoidReality (điều này thường có nghĩa là SteamVR đang chạy và kết nối với VoidReality bằng driver SteamVR của VoidReality).
...
trackers_still_on-modal-description =
    ...
    Bạn vẫn muốn thoát khỏi VoidReality?
trackers_still_on-modal-confirm = Thoát VoidReality
...
status_system-StatusSteamVRDisconnected =
    { $type ->
        [steamvr_feeder] Chưa kết nối với SteamVR thông qua trình điều khiển VoidReality Feeder App.
       *[other] Chưa kết nối với SteamVR thông qua driver VoidReality.
    }
...
unknown_device-modal-description =
    ...
    Bạn có muốn kết nối nó với VoidReality không?
