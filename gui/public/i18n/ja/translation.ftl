...
version_update-description = { version_update-update }をクリックすると、VoidRealityインストーラーがダウンロードされます。
...
tips-turn_on_tracker = VoidRealityの公式トラッカーを使っていますか？トラッカーをPCに接続した後は<b><em>必ず電源を入れて</em></b>ください!
...
widget-developer_mode-filter_slimes_and_hmd = VoidRealityとHMDのみを表示
...
settings-general-steamvr-description =
    ...
    VoidRealityが行うことをよりコントロールしたい場合に便利です。
...
settings-osc-router-network-description =
    ...
    これらはVoidRealityサーバーで使用する他のポートと同じでかまいません。
...
onboarding-home = VoidRealityへようこそ
...
onboarding-automatic_mounting-description = VoidRealityのトラッカーを動作させるためには、物理的なトラッカーの取り付け位置と合わせるために、トラッカーの取り付け方向を合わせる必要があります。
...
onboarding-automatic_proportions-description = VoidRealityのトラッカーが動作するためには、あなたの骨の長さを知る必要があります。この短いキャリブレーションでそれを測定します。
...
trackers_still_on-modal-confirm = VoidRealityを終了する
...
status_system-StatusSteamVRDisconnected =
    { $type ->
        [steamvr_feeder] VoidReality Feederアプリに接続されていません
       *[other] VoidRealityドライバ経由でSteamVRに接続されていません
    }
