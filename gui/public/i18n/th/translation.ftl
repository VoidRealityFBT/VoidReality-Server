...
websocket-connection_lost-desc = ดูเหมือนว่าเซิร์ฟเวอร์ VoidReality หยุดการตอบสนองหรือการเชื่อมต่อขาดหาย กรุณาตรวจสอบไฟล์บันทึกและรีสตาร์ทโปรแกรม
websocket-timedout = ไม่สามารถเชื่อมต่อกับเซิร์ฟเวอร์ได้
websocket-timedout-desc = ดูเหมือนว่าเซิร์ฟเวอร์ VoidReality ขัดข้องหรือหมดเวลาการเชื่อมต่อ กรุณาตรวจสอบไฟล์บันทึกและรีสตาร์ทโปรแกรม
websocket-error-close = ออกจาก VoidReality
websocket-error-logs = เปิดโฟลเดอร์ไฟล์บันทึก

## Update notification

version_update-title = มีเวอร์ชันใหม่พร้อมแล้ว: { $version }
version_update-description = คลิกที่ "{ version_update-update }" เพื่อดาวน์โหลดตัวติดตั้ง VoidReality ให้คุณ
...
tips-turn_on_tracker = คุณใช้แทร็กเกอร์ VoidReality Official หรือไม่?<b><em>หากใช้ อย่าลืมเปิดแทร็กเกอร์หลังจากเชื่อมต่อกับ PC!</em></b>
...
board_type-SLIMEVR_DEV = บอร์ดพัฒนา VoidReality
...
board_type-GLOVE_IMU_SLIMEVR_DEV = บอร์ดพัฒนาถุงมือ IMU VoidReality
...
tracker-settings-forget-description = ลบแทร็กเกอร์ออกจากเซิร์ฟเวอร์ VoidReality และป้องกันไม่ให้เชื่อมต่อจนกว่าจะรีสตาร์ทเซิร์ฟเวอร์ การตั้งค่าของแทร็กเกอร์จะไม่สูญหาย
...
settings-general-interface-connected_trackers_warning-description = ตัวเลือกนี้จะแสดงหน้าต่างป๊อปอัพทุกครั้งที่คุณพยายามออกจาก VoidReality ในขณะที่มีแทร็กเกอร์เชื่อมต่ออยู่ตั้งแต่หนึ่งตัวขึ้นไป เตือนให้คุณปิดแทร็กเกอร์เมื่อใช้งานเสร็จเพื่อรักษาอายุแบตเตอรี่
...
settings-general-interface-use_tray-description = ช่วยให้คุณสามารถปิดหน้าต่างโดยไม่ต้องปิด VoidReality Server คุณจึงสามารถใช้งานต่อได้โดยไม่มี GUI รบกวน
...
settings-general-interface-discord_presence-description = บอกโปรแกรม Discord ของคุณว่าคุณกำลังใช้ VoidReality พร้อมกับจำนวนแทร็กเกอร์ IMU ที่คุณกำลังใช้
...
settings-interface-behavior-error_tracking-description_v2 =
    ...
    <b>เราไม่เก็บรวบรวมข้อมูลส่วนบุคคล</b> เช่น ที่อยู่ IP หรือข้อมูลประจำตัว Wi-Fi ของคุณ VoidReality ให้ความสำคัญกับความเป็นส่วนตัวของคุณ!
    
    เพื่อมอบประสบการณ์การใช้งานที่ดีที่สุด เราจึงรวบรวมรายงานข้อผิดพลาดที่ไม่ระบุตัวตน, เมตริกประสิทธิภาพ, และข้อมูลระบบปฏิบัติการ สิ่งนี้ช่วยให้เราตรวจจับบักและปัญหาของ VoidReality ได้ เมตริกเหล่านี้จะถูกรวบรวมผ่าน Sentry.io
...
settings-osc-router-network-description =
    ...
    อาจใช้พอร์ตเดียวกับพอร์ตอื่นที่ใช้ในเซิร์ฟเวอร์ VoidReality ก็ได้
...
settings-osc-vmc-description =
    ...
    เพื่อส่งข้อมูลกระดูกของ VoidReality และรับข้อมูลกระดูกจากแอปพลิเคชันอื่น
...
settings-utils-advanced-open_data-description-v1 = เปิดโฟลเดอร์การตั้งค่าของ VoidReality โดยภายในจะมีไฟล์การตั้งค่าโปรแกรม
settings-utils-advanced-open_data-label = เปิดโฟลเดอร์
settings-utils-advanced-open_logs = โฟลเดอร์บันทึก
settings-utils-advanced-open_logs-description = เปิดโฟลเดอร์บันทึกไฟล์ของ VoidReality โดยภายในจะมีไฟล์บันทึกการทำงานของแอป
...
onboarding-setup_warning =
    ...
    จำเป็นต้องดำเนินการหากนี่เป็นครั้งแรกที่คุณใช้ VoidReality
...
onboarding-wifi_creds-description-v2 =
    แทร็กเกอร์ส่วนใหญ่ (เช่นแทร็กเกอร์ทางการของ VoidReality ) ใช้ Wi-Fi เพื่อเชื่อมต่อกับเซิร์ฟเวอร์ 
...
onboarding-home = ยินดีต้อนรับสู่ VoidReality!
...
onboarding-connect_serial-error-modal-no_serial_device_found-desc =
    ...
    หากยังไม่ได้ผล:
      ...
      - ลองติดตั้ง VoidReality Server ใหม่และเลือก "USB Drivers" ในส่วน Components
...
onboarding-automatic_mounting-description = เพื่อให้แทร็กเกอร์ VoidReality ทำงานได้ เราจำเป็นต้องกำหนดทิศทางการติดตั้งให้กับแทร็กเกอร์ของคุณเพื่อจัดแนวให้ตรงกับการติดตั้งแทร็กเกอร์บนร่างกายคุณ
...
onboarding-automatic_proportions-description = เพื่อให้ VoidReality แทร็กเกอร์ทำงานได้ เราจะต้องรู้ความยาวของกระดูกของคุณ การตั้งศูนย์อย่างไวนี้จะวัดค่ามันให้คุณ
...
onboarding-automatic_proportions-requirements-descriptionv2 =
    ...
    แทร็กเกอร์และแว่นของคุณเชื่อมต่อกับเซิร์ฟเวอร์ VoidReality และทำงานได้อย่างถูกต้อง (เช่น ไม่กระตุก, ไม่หลุดการเชื่อมต่อ, เป็นต้น)
    แว่นของคุณกำลังส่งข้อมูลตำแหน่งไปยังเซิร์ฟเวอร์ VoidReality (โดยทั่วไปหมายถึงการเปิดใช้งาน SteamVR และเชื่อมต่อกับ VoidReality โดยใช้ไดรเวอร์ SteamVR ของ VoidReality)
...
onboarding-user_height-description = เราต้องการความสูงของคุณเพื่อคำนวณสัดส่วนร่างกายและแสดงการเคลื่อนไหวของคุณอย่างแม่นยำ คุณสามารถให้ VoidReality คำนวณให้ หรือป้อนความสูงเองด้วยตนเอง
...
trackers_still_on-modal-description =
    ...
    คุณยังต้องการออกจาก VoidReality หรือไม่?
trackers_still_on-modal-confirm = ออกจาก VoidReality
...
status_system-StatusSteamVRDisconnected =
    { $type ->
        [steamvr_feeder] ขณะนี้ยังไม่มีการเชื่อมต่อกับแอป VoidReality Feeder
       *[steamvr] ขณะนี้ยังไม่มีการเชื่อมต่อกับ SteamVR ผ่านไดรเวอร์ VoidReality
    }
...
status_system-StatusPublicNetwork = โปรไฟล์เครือข่ายของคุณตอนนี้ถูกตั้งค่าเป็นสาธารณะ ({ $adapters }) ในขณะนี้ ซึ่งไม่แนะนำสำหรับการทำงานของ VoidReality <PublicFixLink>สามารถดูวิธีการแก้ไขได้ที่นี่</PublicFixLink>
...
firmware_tool-not_compatible = เครื่องมือเฟิร์มแวร์ไม่เข้ากันกับ VoidReality Server เวอร์ชันนี้ โปรดอัปเดต VoidReality Server ของคุณ!
...
firmware_tool-flashbtn_step-board_SLIMEVR = ปิดแทร็กเกอร์ของคุณ ถอดบอร์ดออกจากเคส(ถ้ามี) แล้วต่อสาย USB จากแทร็กเกอร์เข้าสู่คอมพิวเตอร์ จากนั้นทำตามขั้นตอนตามชนิดบอร์ดของ VoidReality คุณ
...
firmware_update-devices-description = โปรดเลือกแทร็กเกอร์ที่คุณต้องการอัปเดตเป็นเฟิร์มแวร์ VoidReality เวอร์ชันล่าสุด
...
unknown_device-modal-description =
    ...
    คุณต้องการให้เชื่อมต่อกับ VoidReality  หรือไม่?
...
vrc_config-page-desc = หน้านี้แสดงการตั้งค่าใน VRChat ของคุณ และการตั้งค่าที่ไม่เข้ากับ VoidReality เราแนะนำเป็นอย่างยิ่งให้คุณแก้ไขการแจ้งเตือนที่แสดงให้เห็นเพื่อประสบการณ์การใช้ VoidReality ที่ดีที่สุด
...
tracking_checklist-status-incomplete = คุณยังไม่พร้อมที่จะใช้ VoidReality!
tracking_checklist-status-partial = คุณมี { $count } คำเตือน!
tracking_checklist-status-complete = คุณพร้อมที่จะใช้ VoidReality แล้ว!
...
tracking_checklist-NETWORK_PROFILE_PUBLIC-desc =
    โปรไฟล์เครือข่ายของคุณ ({ $adapters }) ถูกตั้งค่าเป็น สาธารณะ (Public) อยู่ในขณะนี้ ซึ่งไม่แนะนำสำหรับการทำงานที่ถูกต้องของ VoidReality
