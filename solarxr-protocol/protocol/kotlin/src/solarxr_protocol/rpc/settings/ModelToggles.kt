...
class ModelToggles : Table() {
    ...
    val fallbackTracking : Boolean?
        get() {
            val o = __offset(30)
            return if(o != 0) 0.toByte() != bb.get(o + bb_pos) else null
        }
    val straightLegEmulation : Boolean?
        get() {
            val o = __offset(32)
            return if(o != 0) 0.toByte() != bb.get(o + bb_pos) else null
        }
    companion object {
        ...
        @JvmStatic
        fun createModelToggles(builder: FlatBufferBuilder, extendedSpine: Boolean?, extendedPelvis: Boolean?, extendedKnee: Boolean?, forceArmsFromHmd: Boolean?, floorClip: Boolean?, skatingCorrection: Boolean?, toeSnap: Boolean?, footPlant: Boolean?, selfLocalization: Boolean?, usePosition: Boolean?, enforceConstraints: Boolean?, correctConstraints: Boolean?, fallbackTracking: Boolean?, straightLegEmulation: Boolean?) : Int {
            builder.startTable(15)
            straightLegEmulation?.run { addStraightLegEmulation(builder, straightLegEmulation) }
            fallbackTracking?.run { addFallbackTracking(builder, fallbackTracking) }
        ...
        @JvmStatic
        fun startModelToggles(builder: FlatBufferBuilder) = builder.startTable(15)
        @JvmStatic
        ...
        @JvmStatic
        fun addFallbackTracking(builder: FlatBufferBuilder, fallbackTracking: Boolean) = builder.addBoolean(13, fallbackTracking, false)
        @JvmStatic
        fun addStraightLegEmulation(builder: FlatBufferBuilder, straightLegEmulation: Boolean) = builder.addBoolean(14, straightLegEmulation, false)
        @JvmStatic
