...
class StayAlignedSettings : Table() {
    ...
    val pauseCenteringWhenNotUpright : Boolean
        get() {
            val o = __offset(36)
    ...
    companion object {
        ...
        @JvmStatic
        fun createStayAlignedSettings(builder: FlatBufferBuilder, enabled: Boolean, extraYawCorrection: Boolean, hideYawCorrection: Boolean, standingEnabled: Boolean, standingUpperLegAngle: Float, standingLowerLegAngle: Float, standingFootAngle: Float, sittingEnabled: Boolean, sittingUpperLegAngle: Float, sittingLowerLegAngle: Float, sittingFootAngle: Float, flatEnabled: Boolean, flatUpperLegAngle: Float, flatLowerLegAngle: Float, flatFootAngle: Float, setupComplete: Boolean, pauseCenteringWhenNotUpright: Boolean) : Int {
            ...
            addPauseCenteringWhenNotUpright(builder, pauseCenteringWhenNotUpright)
        ...
        @JvmStatic
        fun startStayAlignedSettings(builder: FlatBufferBuilder) = builder.startTable(17)
        @JvmStatic
        ...
        @JvmStatic
        fun addPauseCenteringWhenNotUpright(builder: FlatBufferBuilder, pauseCenteringWhenNotUpright: Boolean) = builder.addBoolean(16, pauseCenteringWhenNotUpright, true)
        @JvmStatic
