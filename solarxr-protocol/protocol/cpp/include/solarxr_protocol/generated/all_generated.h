...
struct TrackerInfo FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  /// Measured yaw drift rate in degrees per minute, updated by the server at each reset
  flatbuffers::Optional<float> drift_rate() const {
    return GetOptional<float, float>(VT_DRIFT_RATE);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<float>(verifier, VT_DRIFT_RATE, 4) &&
           verifier.EndTable();
  }
};
...
struct TrackerInfoBuilder {
  ...
  void add_drift_rate(float drift_rate) {
    fbb_.AddElement<float>(TrackerInfo::VT_DRIFT_RATE, drift_rate);
  }
...
inline flatbuffers::Offset<TrackerInfo> CreateTrackerInfo(
    ...
    flatbuffers::Optional<float> drift_rate = flatbuffers::nullopt) {
  TrackerInfoBuilder builder_(_fbb);
  if(drift_rate) { builder_.add_drift_rate(*drift_rate); }
...
struct ModelToggles FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    ...
    VT_FALLBACK_TRACKING = 30,
    VT_STRAIGHT_LEG_EMULATION = 32
  };
  ...
  flatbuffers::Optional<bool> fallback_tracking() const {
    return GetOptional<uint8_t, bool>(VT_FALLBACK_TRACKING);
  }
  flatbuffers::Optional<bool> straight_leg_emulation() const {
    return GetOptional<uint8_t, bool>(VT_STRAIGHT_LEG_EMULATION);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<uint8_t>(verifier, VT_FALLBACK_TRACKING, 1) &&
           VerifyField<uint8_t>(verifier, VT_STRAIGHT_LEG_EMULATION, 1) &&
           verifier.EndTable();
  }
};
...
struct ModelTogglesBuilder {
  ...
  void add_fallback_tracking(bool fallback_tracking) {
    fbb_.AddElement<uint8_t>(ModelToggles::VT_FALLBACK_TRACKING, static_cast<uint8_t>(fallback_tracking));
  }
  void add_straight_leg_emulation(bool straight_leg_emulation) {
    fbb_.AddElement<uint8_t>(ModelToggles::VT_STRAIGHT_LEG_EMULATION, static_cast<uint8_t>(straight_leg_emulation));
  }
...
inline flatbuffers::Offset<ModelToggles> CreateModelToggles(
    ...
    flatbuffers::Optional<bool> fallback_tracking = flatbuffers::nullopt,
    flatbuffers::Optional<bool> straight_leg_emulation = flatbuffers::nullopt) {
  ModelTogglesBuilder builder_(_fbb);
  if(straight_leg_emulation) { builder_.add_straight_leg_emulation(*straight_leg_emulation); }
  if(fallback_tracking) { builder_.add_fallback_tracking(*fallback_tracking); }
...
struct StayAlignedSettings FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    ...
    VT_FLATFOOTANGLE = 32,
    VT_SETUPCOMPLETE = 34,
    VT_PAUSECENTERINGWHENNOTUPRIGHT = 36
  };
  bool enabled() const {
    return GetField<uint8_t>(VT_ENABLED, 0) != 0;
  }
  ...
  bool pauseCenteringWhenNotUpright() const {
    return GetField<uint8_t>(VT_PAUSECENTERINGWHENNOTUPRIGHT, 1) != 0;
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint8_t>(verifier, VT_ENABLED, 1) &&
           ...
           VerifyField<uint8_t>(verifier, VT_PAUSECENTERINGWHENNOTUPRIGHT, 1) &&
           verifier.EndTable();
  }
};
...
struct StayAlignedSettingsBuilder {
  ...
  void add_pauseCenteringWhenNotUpright(bool pauseCenteringWhenNotUpright) {
    fbb_.AddElement<uint8_t>(StayAlignedSettings::VT_PAUSECENTERINGWHENNOTUPRIGHT, static_cast<uint8_t>(pauseCenteringWhenNotUpright), 1);
  }
...
inline flatbuffers::Offset<StayAlignedSettings> CreateStayAlignedSettings(
    ...
    bool pauseCenteringWhenNotUpright = true) {
  ...
  builder_.add_pauseCenteringWhenNotUpright(pauseCenteringWhenNotUpright);
