...
impl<'a> TrackerInfo<'a> {
  ...
  pub const VT_DRIFT_RATE: flatbuffers::VOffsetT = 32;
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    if let Some(x) = args.drift_rate { builder.add_drift_rate(x); }
  ...
  #[inline]
  pub fn drift_rate(&self) -> Option<f32> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f32>(TrackerInfo::VT_DRIFT_RATE, None)}
  }
}
...
impl flatbuffers::Verifiable for TrackerInfo<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<f32>("drift_rate", Self::VT_DRIFT_RATE, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b> TrackerInfoBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_drift_rate(&mut self, drift_rate: f32) {
    self.fbb_.push_slot_always::<f32>(TrackerInfo::VT_DRIFT_RATE, drift_rate);
  }
  #[inline]
