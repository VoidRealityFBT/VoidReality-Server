...
impl<'a> StayAlignedSettings<'a> {
  ...
  pub const VT_PAUSECENTERINGWHENNOTUPRIGHT: flatbuffers::VOffsetT = 36;
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    builder.add_pauseCenteringWhenNotUpright(args.pauseCenteringWhenNotUpright);
  ...
  #[inline]
  pub fn pauseCenteringWhenNotUpright(&self) -> bool {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(StayAlignedSettings::VT_PAUSECENTERINGWHENNOTUPRIGHT, Some(true)).unwrap()}
  }
}
...
impl flatbuffers::Verifiable for StayAlignedSettings<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<bool>("pauseCenteringWhenNotUpright", Self::VT_PAUSECENTERINGWHENNOTUPRIGHT, false)?
     .finish();
    Ok(())
  }
}
pub struct StayAlignedSettingsArgs {
    ...
    pub pauseCenteringWhenNotUpright: bool,
}
...
impl<'a: 'b, 'b> StayAlignedSettingsBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_pauseCenteringWhenNotUpright(&mut self, pauseCenteringWhenNotUpright: bool) {
    self.fbb_.push_slot::<bool>(StayAlignedSettings::VT_PAUSECENTERINGWHENNOTUPRIGHT, pauseCenteringWhenNotUpright, true);
  }
  #[inline]
...
impl core::fmt::Debug for StayAlignedSettings<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("StayAlignedSettings");
      ...
      ds.field("pauseCenteringWhenNotUpright", &self.pauseCenteringWhenNotUpright());
      ds.finish()
  }
}
