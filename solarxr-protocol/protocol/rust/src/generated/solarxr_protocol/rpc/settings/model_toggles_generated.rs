...
impl<'a> ModelToggles<'a> {
  ...
  pub const VT_FALLBACK_TRACKING: flatbuffers::VOffsetT = 30;
  pub const VT_STRAIGHT_LEG_EMULATION: flatbuffers::VOffsetT = 32;
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    if let Some(x) = args.straight_leg_emulation { builder.add_straight_leg_emulation(x); }
    if let Some(x) = args.fallback_tracking { builder.add_fallback_tracking(x); }
  ...
  #[inline]
  pub fn fallback_tracking(&self) -> Option<bool> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(ModelToggles::VT_FALLBACK_TRACKING, None)}
  }
  #[inline]
  pub fn straight_leg_emulation(&self) -> Option<bool> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(ModelToggles::VT_STRAIGHT_LEG_EMULATION, None)}
  }
}
...
impl flatbuffers::Verifiable for ModelToggles<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<bool>("fallback_tracking", Self::VT_FALLBACK_TRACKING, false)?
     .visit_field::<bool>("straight_leg_emulation", Self::VT_STRAIGHT_LEG_EMULATION, false)?
     .finish();
    Ok(())
  }
}
pub struct ModelTogglesArgs {
    ...
    pub fallback_tracking: Option<bool>,
    pub straight_leg_emulation: Option<bool>,
}
...
impl<'a: 'b, 'b> ModelTogglesBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_fallback_tracking(&mut self, fallback_tracking: bool) {
    self.fbb_.push_slot_always::<bool>(ModelToggles::VT_FALLBACK_TRACKING, fallback_tracking);
  }
  #[inline]
  pub fn add_straight_leg_emulation(&mut self, straight_leg_emulation: bool) {
    self.fbb_.push_slot_always::<bool>(ModelToggles::VT_STRAIGHT_LEG_EMULATION, straight_leg_emulation);
  }
  #[inline]
...
impl core::fmt::Debug for ModelToggles<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("ModelToggles");
      ...
      ds.field("fallback_tracking", &self.fallback_tracking());
      ds.field("straight_leg_emulation", &self.straight_leg_emulation());
      ds.finish()
  }
}
