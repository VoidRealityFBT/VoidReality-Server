...
public final class TrackerInfo extends Table {
   ...
   */
  public boolean hasDriftRate() { return 0 != __offset(32); }
  public float driftRate() { int o = __offset(32); return o != 0 ? bb.getFloat(o + bb_pos) : 0f; }
  ...
  public static void addDriftRate(FlatBufferBuilder builder, float driftRate) { builder.addFloat(14, driftRate, 0f); }
  ...
  public void unpackTo(TrackerInfoT _o) {
    ...
    Float _oDriftRate = hasDriftRate() ? driftRate() : null;
    _o.setDriftRate(_oDriftRate);
  }
  public static int pack(FlatBufferBuilder builder, TrackerInfoT _o) {
    ...
    if (_o.getDriftRate() != null) { addDriftRate(builder, _o.getDriftRate()); }
