...
public final class ModelToggles extends Table {
  ...
  public boolean hasFallbackTracking() { return 0 != __offset(30); }
  public boolean fallbackTracking() { int o = __offset(30); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  public boolean hasStraightLegEmulation() { return 0 != __offset(32); }
  public boolean straightLegEmulation() { int o = __offset(32); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  ...
  public static int createModelToggles(FlatBufferBuilder builder,
      ...
      boolean fallbackTracking,
      boolean straightLegEmulation) {
    builder.startTable(15);
    ModelToggles.addStraightLegEmulation(builder, straightLegEmulation);
    ModelToggles.addFallbackTracking(builder, fallbackTracking);
  ...
  public static void startModelToggles(FlatBufferBuilder builder) { builder.startTable(15); }
  ...
  public static void addFallbackTracking(FlatBufferBuilder builder, boolean fallbackTracking) { builder.addBoolean(13, fallbackTracking, false); }
  public static void addStraightLegEmulation(FlatBufferBuilder builder, boolean straightLegEmulation) { builder.addBoolean(14, straightLegEmulation, false); }
  ...
  public void unpackTo(ModelTogglesT _o) {
    ...
    Boolean _oFallbackTracking = hasFallbackTracking() ? fallbackTracking() : null;
    _o.setFallbackTracking(_oFallbackTracking);
    Boolean _oStraightLegEmulation = hasStraightLegEmulation() ? straightLegEmulation() : null;
    _o.setStraightLegEmulation(_oStraightLegEmulation);
  }
  public static int pack(FlatBufferBuilder builder, ModelTogglesT _o) {
    ...
    return createModelToggles(
      ...
      _o.getFallbackTracking(),
      _o.getStraightLegEmulation());
  }
}
