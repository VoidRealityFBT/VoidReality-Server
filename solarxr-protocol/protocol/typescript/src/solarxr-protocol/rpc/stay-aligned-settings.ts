...
static addPauseCenteringWhenNotUpright(builder:flatbuffers.Builder, pauseCenteringWhenNotUpright:boolean) {
  builder.addFieldInt8(16, +pauseCenteringWhenNotUpright, +true);
}
...
static createStayAlignedSettings(builder:flatbuffers.Builder, enabled:boolean, extraYawCorrection:boolean, hideYawCorrection:boolean, standingEnabled:boolean, standingUpperLegAngle:number, standingLowerLegAngle:number, standingFootAngle:number, sittingEnabled:boolean, sittingUpperLegAngle:number, sittingLowerLegAngle:number, sittingFootAngle:number, flatEnabled:boolean, flatUpperLegAngle:number, flatLowerLegAngle:number, flatFootAngle:number, setupComplete:boolean, pauseCenteringWhenNotUpright:boolean):flatbuffers.Offset {
  ...
  StayAlignedSettings.addPauseCenteringWhenNotUpright(builder, pauseCenteringWhenNotUpright);
...
unpack(): StayAlignedSettingsT {
  return new StayAlignedSettingsT(
    ...
    this.flatFootAngle(),
    this.setupComplete(),
    this.pauseCenteringWhenNotUpright()
  );
}
...
unpackTo(_o: StayAlignedSettingsT): void {
  ...
  _o.pauseCenteringWhenNotUpright = this.pauseCenteringWhenNotUpright();
}
}
...
constructor(
  ...
  public pauseCenteringWhenNotUpright: boolean = true
){}
