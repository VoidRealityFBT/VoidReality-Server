...
fallbackTracking():boolean|null {
  const offset = this.bb!.__offset(this.bb_pos, 30);
  return offset ? !!this.bb!.readInt8(this.bb_pos + offset) : null;
}

straightLegEmulation():boolean|null {
...
static addFallbackTracking(builder:flatbuffers.Builder, fallbackTracking:boolean) {
  builder.addFieldInt8(13, +fallbackTracking, 0);
}

static addStraightLegEmulation(builder:flatbuffers.Builder, straightLegEmulation:boolean) {
  builder.addFieldInt8(14, +straightLegEmulation, 0);
}
...
static createModelToggles(builder:flatbuffers.Builder, extendedSpine:boolean|null, extendedPelvis:boolean|null, extendedKnee:boolean|null, forceArmsFromHmd:boolean|null, floorClip:boolean|null, skatingCorrection:boolean|null, toeSnap:boolean|null, footPlant:boolean|null, selfLocalization:boolean|null, usePosition:boolean|null, enforceConstraints:boolean|null, correctConstraints:boolean|null, fallbackTracking:boolean|null, straightLegEmulation:boolean|null):flatbuffers.Offset {
...
unpackTo(_o: ModelTogglesT): void {
  ...
  _o.fallbackTracking = this.fallbackTracking();
  _o.straightLegEmulation = this.straightLegEmulation();
}
}
...
constructor(
  ...
  public fallbackTracking: boolean|null = null,
  public straightLegEmulation: boolean|null = null
){}
